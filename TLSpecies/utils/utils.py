...
def pc_from_las(filename):
    """
    Loads a point cloud from a .las file
    
    Parameters:
    filename:string - location for the .las file
...
def plot_depth_images(depth_images, nrows=2, figsize=None, title=None):
    """
